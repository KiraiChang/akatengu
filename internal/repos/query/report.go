...
type sqlReportRepo struct {
	db *sqlx.DB
}

func NewReportRepo(db *sqlx.DB) ReportRepo {
	return &sqlReportRepo{db: db}
}

func (r *sqlReportRepo) GetBalanceSheet(ctx context.Context, reportDate string) (*report.BalanceSheet, error) {
...
func (r *sqlReportRepo) GetIncomeStatement(ctx context.Context, startDate, endDate string) (*report.IncomeStatement, error) {
