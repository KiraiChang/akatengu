...
INSERT INTO transactions
    (merchant_id, txn_date, description, total_amount, currency, status, receipt_no, note, version, ref_txn_id, updated_by)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?);
...
INSERT INTO journal_entries
    (merchant_id, txn_id, ledger_id, account_id, debit, credit, note, cash_flow_category, updated_by)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);

-- name: InsertJournalEntryWithID :exec
INSERT INTO journal_entries
    (entry_id, merchant_id, txn_id, ledger_id, account_id, debit, credit, note, cash_flow_category, updated_by)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
